// iniciar las variables de puntaje, clicks y movimientos
var puntos=0;
    movimientos=0;
    clicks=0;

// codigo para cambiar el color al titulo
setInterval(function(){
  var tituloColor = $(".main-titulo").css("color");
  if (tituloColor=="rgb(220, 255, 14)")
  {
...
$(function(){
  ...
  $('.btn-reinicio').on('click', inicioJuego)

})

//Iniciar un juego, o reiniciar
...
function tiempoAcabo(){
  ...
  $('.time').hide(500)
  $('#score-text').hide()
  $('.score').append("<span class='data-info' id='score-final'>"+puntos+"</span>")
}
